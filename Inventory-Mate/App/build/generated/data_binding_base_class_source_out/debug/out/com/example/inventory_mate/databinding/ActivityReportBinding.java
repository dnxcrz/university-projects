...
public final class ActivityReportBinding implements ViewBinding {
  ...
  private ActivityReportBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView recyclerView, @NonNull Button shareReportButton) {
  ...
  public static ActivityReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.share_report_button;
      Button shareReportButton = ViewBindings.findChildViewById(rootView, id);
      if (shareReportButton == null) {
        break missingId;
      }

      return new ActivityReportBinding((ConstraintLayout) rootView, recyclerView,
          shareReportButton);
    }
